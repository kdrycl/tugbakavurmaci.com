        ...
        <section class="hero-area">
                <div class="postbox__gallery mb-35">
                    ...
                    foreach ($sliders as $keySlider => $sliders) {?>
                        <img src="<?php echo $sliders['path']?>" alt="<?php echo $sliders['text1'];?>">
                    <?php } ?>
                </div>
        </section>
        <!-- hero-area end -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-5 d-none d-lg-block">
                        <div class="section-button text-right pt-80">
                            <a data-animation="fadeInLeft" data-delay=".6s" href="bloglar" class="btn btn-icon ml-0"><span> + </span> Bloglara Git</a>
                        </div>
                    </div>
                </div>
                <div class="row">
