...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
    $detectedServices = $dbclass->cek("ASSOC","services","*","where id=?",array($_GET['id']));
  ?>
    <!DOCTYPE html>
    <html lang="tr">
    <!--begin::Head-->
                                          ...
                                          ?>
                                            <form class="form" id="services_form">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   ...
                                                                   name="servicesname"
                                                                   autocomplete="off" value="<?php echo $detectedServices['name'];?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   ...
                                                                   name="sorttext"
                                                                   autocomplete="off" value="<?php echo $detectedServices['sorttext'];?>"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label class="col-form-label">Hizmet İcon (120x122) </label>
                                                        <div class="dropzone dropzone-default dropzone-primary"
                                                             id="servicesDesktop2">
                                                            <div class="dropzone-msg dz-message needsclick">
                                                                <h3 class="dropzone-msg-title">Görsel Yüklemek İçin Tıklayın yada Sürükleyin</h3>
                                                                ...
                                                                <div class="col-12 border-lg justify-content-center rounded bg-white pb-3 text-center my-4 py-2">
                                                                    ...
                                                                    <img class="img-fluid" style="max-height:250px;" alt="" src="../<?php echo $detectedServices['icon2'];?>">                              
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="dropzone dropzone-default dropzone-primary"
                                                            ...
                                                            <div class="dropzone-msg dz-message needsclick">
                                                                ...
                                                                <div class="col-12 border-lg justify-content-center rounded bg-white pb-3 text-center my-4 py-2">
                                                                    <b style="font-size:15px;">Yüklü resim yeni resim yüklediğinizde güncellenir..</b>
                                                                    <img class="img-fluid" style="max-height:250px;" alt="" src="../<?php echo $detectedServices['img'];?>">                              
                                                                    <!-- <a class="imageDelete btn btn-link text-info" data-id="no-image">Resmi Sil</a> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <div class="form-group mb-5">
                                                        ...
                                                        <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                ...
                                                                name="sort"
                                                                autocomplete="off" value="<?php echo $detectedServices['sort'];?>"/>
