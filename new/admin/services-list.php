...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
    ...
    <head>
        <base href="">
        <meta charset="utf-8"/>
        <title><?php echo $pageTitle?> Listeleniyor</title>
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Title-->
                                    <h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $pageTitle?> Listeleniyor</h2>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                            </div>
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    // if ($permissionControl == 0) {  // kullanıcının, yönetim panelinde kullanıcı ekleme ve düzenleme izni kontrol ediliyor
                                    //     $functions->errorList("noBlogDelete");
                                    // }
                                    ?>
                                </div>
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label"><?php echo $pageTitle?> İşlemleri
                                            <span class="d-block text-muted pt-2 font-size-sm">
												Bu menüde var olan <?php echo $pageTitle?> inceleyebilir, silebilir ve yeni <?php echo $pageTitle?>  ekleyebilirsiniz.</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="yeni-hizmet" class="btn btn-primary font-weight-bolder">
                                            <i class="fas fa-boxes"></i>
                                            </span>Yeni <?php echo $pageTitle?> Ekle</a>
                                        <!--end::Button-->
                                    </div>
                                </div>
                                <!--end::Header-->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row align-items-end">
                                                    <div class="col-12 col-lg-4">
                                                        <label for="sliderSearch"><?php echo $pageTitle?> Arama</label>
                                                        <div class="input-icon">
                                                            <input type="text" name="sliderSearch" class="form-control"
                                                                   placeholder="<?php echo $pageTitle?> Arama..." id="sliderSearch"/>
                                                            <span>
    ...
    <script src="assets/js/pages/custom/services/datatable.js"></script>
    <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
    </html>
