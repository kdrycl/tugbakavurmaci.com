...
<html lang="tr">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Yeni Kategori Ekleniyor</title>
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Yeni Kategori Ekleniyor</h2>
										<!--end::Title-->
									</div>
									<!--end::Heading-->
								</div>
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-3 font-weight-bold font-size-sm">Eklemek İstediğiniz Kategorinin Bilgilerini Bu Alandan Doldurabilirsiniz.</span>
												</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
														...
														<div class="col-12 col-lg-6">
															<div class="form-group mb-5">
																...
																<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Kategori Adı"
																	name="categoryName" autocomplete="off" value=""/>
															</div>
														</div>
														<div class="col-12 col-lg-6">
															<div class="form-group mb-5">
																...
																<select class="form-control form-control-lg form-control-solid" id="mainCategory" name="mainCategory">
																	...
																	<?php
																		$countryGet=$dbclass->cek("ASSOC_ALL","categories","*","WHERE langCode=?",array("TR"));
																		foreach ($countryGet as $key => $value) {
														...
														<div class="col-12 col-lg-6 d-none">
															<div class="form-group mb-5">
																...
																<select class=" form-control form-control-lg form-control-solid" id="categoryType" name="categoryType">
																	...
																	<option value="1" selected>Blog Kategorisi</option>
														...
														<div class="col-12 col-lg-4 d-none" >
															<div class="form-group mb-5">
																...
																<select class="form-control form-control-lg form-control-solid" id="showMenu" name="showMenu">
																	<option value="1" selected>Gösterilsin</option>
													...
													<div class="row">
														<div class="col-12 col-lg-12">
															<div class="form-group">
																...
																<textarea class="form-control form-control-solid form-control-lg" name="categoryDescription" rows="4"></textarea>
															</div>
														</div>
													</div>
                          <!--begin::Group-->
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-12 col-lg-6">
                                ...
                                <input type="hidden" name="categoryProcess" value="add">
                                <input type="hidden" name="langCode" value="TR">
