...
var KTAppsUsersListDatatable = function () {
  ...
  var _demo = function () {
      ...
      columns: [
        {
          ...
          template: function (data) {
            return '<span class="font-weight-bolder">' + data.categoryNumber + '</span>';
          }
        }, {
          field: 'categoryName',
          title: 'Kategori Adı',
          ...
          template: function (row) {
            ...
            return '<span class="font-weight-bold">' + status[row.categoryType].title + '</span>';
          },
        }, {
          field: 'recordStatus',
          title: 'Durumu',
          ...
          template: function (field) {
            return '\<span class="font-weight-bold">' + field.mainCategory + '</span>';
          }
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
                      <ul class="navi flex-column navi-hover py-2">\
                        ...
                        '+ field.actions[0] + '\
										...
										<button type="submit" data-id="'+ field.actions[1] + '" class="categoryDelete btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon" title="Delete">\
											<span class="svg-icon svg-icon-md">\
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
														<rect x="0" y="0" width="24" height="24"/>\
    ...
    datatable.on('click', 'button.categoryDelete', function () {
