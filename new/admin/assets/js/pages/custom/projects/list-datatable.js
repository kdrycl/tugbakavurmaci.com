        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function (row) {
                    ...
                    return '<span class="label label-lg font-weight-bold ' + status[row.donationType].class + ' label-inline">' + status[row.donationType].title + '</span>';
                },
            }, {
                field: 'activityType',
                title: 'Etkinlik Türü',
                ...
                template: function (row) {
                    var status = {
                        0: {
                            'title': 'Sürekli Etkinlik',
                            'class': ' label-light-info'
                        },
                        1: {
                            'title': 'Bütçe Bazlı Etkinlik',
                            'class': ' label-light-info'
                        },
                        2: {
                            'title': 'Zaman Bazlı Etkinlik',
                            'class': ' label-light-info'
                        }
                    };
                    return '<span class="label label-lg font-weight-bold ' + status[row.donationType].class + ' label-inline">' + status[row.donationType].title + '</span>';
