...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
    ...
    <div class="d-flex flex-column flex-root">
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Title-->
                                    <h2 class="text-white font-weight-bold my-2 mr-5">Yeni Kullanıcı Ekleme</h2>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                            </div>
                                        ...
                                        <div class="card-body pt-3 pb-0">
                                            <form class="form" id="user_detail">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">E-Posta
                                                                Adresi</label>
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   type="text" placeholder="E-Posta Adresi"
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   name="password" placeholder="Panel Giriş Şifresi">
        ...
        <div class="modal fade" id="permissionModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
             aria-hidden="true">
