...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
    ...
    <head>
        <base href="">
        <meta charset="utf-8"/>
        <title>Bloglar Listeleniyor</title>
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Title-->
                                    <h2 class="text-white font-weight-bold my-2 mr-5">Bloglar Listeleniyor</h2>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                            </div>
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">Slider İşlemleri
                                            <span class="d-block text-muted pt-2 font-size-sm">
												Bu menüde var olan sliderları inceleyebilir, silebilir ve yeni slider ekleyebilirsiniz.</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="yeni-slider" class="btn btn-primary font-weight-bolder">
                                            <i class="fas fa-boxes"></i>
                                            </span>Yeni Slider Ekle</a>
                                        <!--end::Button-->
                                    </div>
                                </div>
                                <!--end::Header-->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row align-items-end">
                                                    <div class="col-12 col-lg-4">
                                                        <label for="sliderSearch">Sldir Arama</label>
                                                        <div class="input-icon">
                                                            <input type="text" name="sliderSearch" class="form-control"
                                                                   placeholder="Slider Arama..." id="sliderSearch"/>
                                                            <span>
    ...
    <script src="assets/js/pages/custom/slider/datatable.js"></script>
    <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
    </html>
