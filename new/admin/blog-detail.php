...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
  $blogDetail = $dbclass->cek("ASSOC", "blogs", "*", "WHERE id=?", array($_GET['id']));
  ?>
    <!DOCTYPE html>
    <html lang="tr">
    <!--begin::Head-->
    <head>
        <base href="">
        <meta charset="utf-8"/>
        <title><?php echo $blogDetail['blogName'] ?> Adlı Yazı Bilgileri</title>
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Title-->
                                    <h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $blogDetail['blogName'] ?>
                                        Adlı Yazı Bilgileri</h2>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                            </div>
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Blog Yazısı Bilgileri</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Blog Yazısının Bilgilerini Bu Alandan Görüntüleyebilir ve Güncelleyebilirsiniz.</span>
                                            </h3>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div class="card-body pt-3 pb-0">
                                          ...
                                          ?>
                                            <form class="form" id="blog_form">
                                                <div class="row">
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Blog
                                                                Başlığı</label>
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   type="text" placeholder="Blog Yazısı Başlığı"
                                                                   name="blogName" autocomplete="off"
                                                                   value="<?php echo $blogDetail['blogName']; ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                    ...
                                                    <div class="col-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    rows="4"><?php echo $blogDetail['blogShortDescription']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    id="blogLongDescription"><?php echo $blogDetail['blogLongDescription']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--begin::Group-->
                                                <div class="form-group row">
                                                    <div class="col-12 col-lg-12">
                                                        ...
                                                        <input class="form-control form-control-solid form-control-lg"
                                                               name="seoTitle"
                                                               type="text"
                                                               value="<?php echo $blogDetail['seoTitle']; ?>"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <textarea
                                                                ...
                                                                name="seoKeywords"
                                                                rows="5"
                                                                placeholder="SEO Anahtar Kelimeleri Giriniz"><?php echo $blogDetail['seoKeywords']; ?></textarea>
                                                    </div>
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <textarea
                                                                ...
                                                                name="seoDescription"
                                                                rows="5"
                                                                placeholder="SEO Açıklamasını Giriniz"><?php echo $blogDetail['seoDescription']; ?></textarea>
                                                        <input type="hidden" name="blogProcess" value="update">
                                                        <input type="hidden" name="uniqueId"
                                                               value="<?php echo $blogDetail['uniqueId']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        ...
                                                        <select class="form-control form-control-lg form-control-solid select2"
                                                                id="seoTags" name="seoTags[]" multiple="multiple">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label class="col-form-label">Blog Tanıtım Görselleri</label>
    ...
    <script src="assets/js/pages/custom/blogs/blog-detail.js"></script>
