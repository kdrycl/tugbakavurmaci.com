...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
  ?>
    ...
    <head>
        <base href="">
        <meta charset="utf-8"/>
        <title>Yeni Blog Ekleniyor</title>
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Title-->
                                    <h2 class="text-white font-weight-bold my-2 mr-5">Yeni blog Ekleniyor</h2>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                            </div>
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Blog Yazısı İçeriği</span>
                                            ...
                                            <form class="form" id="blog_form">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   type="text" placeholder="Blog Başlığı"
                                                                   name="blogName"
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <select class="form-control form-control-lg form-control-solid"
                                                              ...
                                                              <?php
                                                              $categoriesGet = $dbclass->cek("ASSOC_ALL", "categories", "*", "WHERE categoryType=? AND langCode=?", array(1, "TR"));
                                                    ...
                                                    <div class="col-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="blogShortDescription" rows="4"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    id="blogLongDescription"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--begin::Group-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <input type="hidden" name="blogProcess" value="add">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-12">
