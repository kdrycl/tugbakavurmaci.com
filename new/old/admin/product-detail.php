                                        ...
                                        <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#informations">
                                                    ...
                                                    <span class="nav-text font-weight-bold">Ek Bilgiler</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="card card-custom card-stretch gutter-b shadow-none">
                                                            ...
                                                            <div class="card-header border-0 py-5">
                                                                <h3 class="card-title align-items-start flex-column">
                                                                    <span class="card-label font-weight-bolder text-dark">Ürün Ek Bilgileri</span>
                                                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">Bu menü altından ürününüz için ek bilgiler ekleyebilirsiniz.</span>
                                                                </h3>
                                                            </div>
                                                            <!--end::Header-->
                                                            <!--begin::Body-->
                                                                    ...
                                                                    <div class="col-lg-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                   id="infoTitle"
                                                                                   placeholder="Ek Bilgi Başlığı Giriniz"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                   id="infoContent"
                                                                                   placeholder="Ek Bilgi İçeriği Giriniz"/>
                                                                        </div>
