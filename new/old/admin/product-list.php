...
<html lang="tr">
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Ürünler Listeleniyor</h2>
										<!--end::Title-->
									</div>
									<!--end::Heading-->
								</div>
							...
							<div class="container">
								...
								<div class="card card-custom">
									...
									<div class="card-body pb-0">
										...
										if ($permissionControl==0){  // kullanıcının, yönetim panelinde ürün ekleme ve düzenleme izni kontrol ediliyor
											$functions->errorList("noProductDelete");
										}
									?>
									</div>
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Ürün İşlemleri
											<span class="d-block text-muted pt-2 font-size-sm">
												Bu menüde var olan ürünleri inceleyebilir, silebilir ve yeni ürün ekleyebilirsiniz.</span></h3>
										</div>
										<div class="card-toolbar">
											<!--begin::Button-->
											<a href="yeni-urun" class="btn btn-primary font-weight-bolder">
											<i class="fas fa-boxes"></i>
											</span>Yeni Ürün Ekle</a>
											<!--end::Button-->
										</div>
									</div>
									<!--end::Header-->
												...
												<div class="col-lg-12">
													<div class="row align-items-end">
														<div class="col-12 col-lg-4">
															<label for="blogSearch">Ürün Adı ile Arama</label>
															<div class="input-icon">
																<input type="text" name="productSearch"  class="form-control" placeholder="Ürün Arama..." id="productSearch" />
																<span>
    ...
    <!--begin::Page Scripts(used by this page)-->
		<script src="assets/js/pages/custom/products/list-datatable.js?v=7.0.3"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
