...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">Blog İşlemleri
                                            <span class="d-block text-muted pt-2 font-size-sm">
												Bu menüde var olan blog yazılarınızı inceleyebilir, silebilir ve yeni blog yazısı ekleyebilirsiniz.</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="yeni-blog" class="btn btn-primary font-weight-bolder">
                                            <i class="fas fa-boxes"></i>
                                            </span>Yeni Blog Ekle</a>
                                        <!--end::Button-->
                                    </div>
                                </div>
                                <!--end::Header-->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row align-items-end">
                                                    <div class="col-12 col-lg-4">
                                                        <label for="blogSearch">Blog Adı ile Arama</label>
                                                        <div class="input-icon">
                                                            <input type="text" name="blogSearch" class="form-control"
                                                                   placeholder="Ürün Arama..." id="blogSearch"/>
                                                            <span>
    ...
    <script src="assets/js/pages/custom/blogs/list-datatable.js?v=7.0.3"></script>
    <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
    </html>
