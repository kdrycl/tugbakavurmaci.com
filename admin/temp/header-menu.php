            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-rel">
                            <a href="kullanicilari-listele" class="menu-link">
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="urunleri-listele" class="menu-link">
                                            <span class="ml-4 menu-text">Ürün İşlemleri</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                    <!-- begin:: Menu Item -->
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="kategorileri-listele" class="menu-link">
                                            <span class="ml-4 menu-text">Kategori İşlemleri</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                </ul>
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="javascript:" class="menu-link menu-toggle">
                                <span class="menu-text">İçerik Yönetimi</span>
                                <span class="menu-desc"></span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="galeri-listele" class="menu-link">
                                            <span class="ml-4 menu-text">Slider & Banner Yönetimi</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                    <!-- begin:: Menu Item -->
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="sayfalari-listele" class="menu-link">
                                            <span class="ml-4 menu-text">Sayfa İşlemleri</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                    <!-- begin:: Menu Item -->
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="bloglari-listele" class="menu-link">
                                            <span class="ml-4 menu-text">Blog İşlemleri</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                </ul>
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="javascript:" class="menu-link menu-toggle">
                                <span class="menu-text">SEO Yönetimi</span>
                                <span class="menu-desc"></span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="etiketleri-listele" class="menu-link">
                                            <span class="ml-4 menu-text">SEO+ Etiketleri</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                </ul>
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="dilleri-listele" class="menu-link">
                                            <span class="ml-4 menu-text">Dil Yönetimi</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                    <!-- begin:: Menu Item -->
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="firma-bilgileri" class="menu-link">
                                            <span class="ml-4 menu-text">Firma Bilgileri</span>
                                        </a>
                                    </li>
                                    <!-- end:: Menu Item -->
                                </ul>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto">
                        <span class="text-white opacity-70 font-weight-bold font-size-base d-none d-md-inline mr-1">Merhaba,</span>
                      <?php
                      $loginUserDetail = $dbclass->cek("ASSOC", "users", "*", "WHERE id=?", array($_SESSION['userid']['id']));
                      ?>
                        <span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">
              <?php echo $loginUserDetail['name']; ?>
            </span>
                        <span class="symbol symbol-35">
              <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">
                <?php echo substr($loginUserDetail['name'], 0, 1); ?>
              </span>
            </span>
                    </div>
                </div>
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    <div class="d-flex align-items-center p-8 rounded-top">
                        ...
                        <div class="symbol symbol-md bg-light-primary mr-3 flex-shrink-0">
                          <?php
                          $userImage = $functions->imageDetected($dbclass, 2, $loginUserDetail['id']);
                          ?>
                            <img src="<?php echo $userImage; ?>" alt="<?php echo $loginUserDetail['name']; ?>"/>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Text-->
                        <div class="text-dark m-0 flex-grow-1 mr-3 font-size-h5"><?php echo $loginUserDetail['name'] . " " . $loginUserDetail['surname']; ?></div>
                        <!--end::Text-->
                    </div>
                    ...
                    <div class="navi navi-spacer-x-0 pt-5">
                        ...
                        <a href="custom/apps/user/profile-1/personal-information.html" class="navi-item px-8">
                            <div class="navi-link">
                                ...
                                <div class="navi-text">
                                    ...
                                    <div class="text-muted">Hesap Ayarlarım ve Diğer Bilgilerim</div>
                                </div>
                            </div>
                        </a>
                        <!--end::Item-->
                        ...
                        <div class="navi-footer px-8 py-5">
                            <a href="javascript:void(0);"
                               class="btn btn-light-primary btn-block font-weight-bold  cikis-yap">Çıkış Yap</a>
                        </div>
                        <!--end::Footer-->
                    </div>
                    <!--end::Nav-->
