                          ...
                          <?php
                            ...
                            if($value['pageCode']=="HEDMENU"){
                              ...
                              $message="Sitenizin Footer Alanı olarak adlandırılan ve sitenin en altında bulunan kısımdaki dil değişkenlerini bu alandan düzenleyebilirsiniz.";
														...
														else if($value['pageCode']=="PRODET"){
                              $title="Ürün Detay Sayfası Değişkenleri";
                              $message="Sitenizde bulunan ürünlerin detaylı inceleme sayfasında bulunan dil değişkenlerini bu alandan düzenleyebilirsiniz.";
                            } 
														else if($value['pageCode']=="CONTCT"){
                              $title="İletişim Sayfası Değişkenleri";
                              $message="Sitenizin iletişim sayfasında bulunan dil değişkenlerini bu alandan düzenleyebilirsiniz.";
                            } 
														else if($value['pageCode']=="PGEDET"){
                              $title="Sayfa Değişkenleri";
                              $message="Sitenizdeki sayfalarda bulunan dil değişkenlerini bu alandan düzenleyebilirsiniz.";
                            } 
														else{
															$title="Site Dil Değişkenleri";
															$message="Sitenizde bulunan gruplanmamış dil değişkenlerini bu alandan düzenleyebilirsiniz.";
														}
