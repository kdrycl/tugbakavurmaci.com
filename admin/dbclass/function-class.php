...
class functions
{
  public function errorList($errCode)
  {
    ...
    else if ($errCode == "noPageProcess") $errorMessage = "Yeni Sayfa Ekleme ve Sayfaları Güncelleme Yetkiniz Bulunmamaktadır.";
    else if ($errCode == "noPageDelete") $errorMessage = "Sayfa Silme Yetkiniz Bulunmamaktadır.";
    else $errorMessage="Bu İşlem İçin Yetkiniz Bulunmamaktadır.";
