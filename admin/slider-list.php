...
<html lang="tr">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Metroniaac | Empty Page</title>
	...
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<div class="d-flex flex-column">
										<!--begin::Title-->
										<h2 class="text-white font-weight-bold my-2 mr-5">Sayfa Başlığı</h2>
										<!--end::Title-->
									</div>
									<!--end::Heading-->
								</div>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Slider ve Bannerlar Listeleniyor
											<span class="d-block text-muted pt-2 font-size-sm">Bu sayfada var olan slider'larınızı ve Banner'larınızı düzenleyebilirsiniz.</span></h3>
										</div>
									</div>
									<div class="card-body">
										<!--begin: Datatable-->
                    ...
                    <!--begin::Search Form-->
										...
										<!--end::Search Form-->
										<table class="table table-separate table-head-custom table-checkable" id="sliderTable">
											<thead>
												<tr>
												</tr>
											</thead>
		...
		<script src="assets/js/pages/custom/slider/list-datatable.js"></script>
