															...
															<div class="form-group mb-5">
																...
																<select class="form-control form-control-lg form-control-solid" id="categoryType" name="categoryType">
																	<?php
																		...
																		$blogSelect="";
																		$pageSelect="";
																		if($categoryDetail['categoryType']==0)$productSelect="selected";
																		else if ($categoryDetail['categoryType']==1)$blogSelect="selected";
																		else if ($categoryDetail['categoryType']==2)$pageSelect="selected";
																	?>
																	<option value="0"<?php echo $productSelect; ?>>Ürün Kategorisi</option>
																	<option value="1"<?php echo $blogSelect; ?>>Blog Kategorisi</option>
																	<option value="2"<?php echo $pageSelect; ?>>Sayfa Kategorisi</option>
																</select>
															</div>
														</div>
                            <div class="col-12 col-lg-6">
