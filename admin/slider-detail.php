                                          ...
                                          ?>
                                            <form class="form" id="slider_form">
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Slider Linki</label>
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   type="text" placeholder="Slider Linki"
                                                                   name="link"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label class="col-form-label">Slider Mobil Görseli</label>
                                                    ...
                                                    <div class="col-12 border-lg justify-content-center rounded bg-white pb-3 text-center my-4 py-2">
                                                        ...
                                                        <img class="img-fluid" style="max-height:250px;" alt="" src="../<?php echo $detectedSlider['path2']?>">                              
