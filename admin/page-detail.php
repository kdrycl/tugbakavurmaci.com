...
if ($sessionControl > 0) { // kullanıcı giriş yapmış mı kontrol ediliyor giriş yapmışsa sayfaya yönlendiriliyor
  $pageDetail = $dbclass->cek("ASSOC", "pages", "*", "WHERE uniqueId=? AND langCode=?", array($_GET['uniqueId'],$_GET['langCode']));
  ?>
    <!DOCTYPE html>
    <html lang="tr">
    <!--begin::Head-->
    <head>
        <base href="">
        <meta charset="utf-8"/>
        <title><?php echo $pageDetail['pageName'] ?> Adlı Sayfa Bilgileri</title>
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Title-->
                                    <h2 class="text-white font-weight-bold my-2 mr-5"><?php echo $pageDetail['pageName'] ?>
                                        Adlı Sayfa Bilgileri</h2>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                            </div>
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Sayfa Bilgileri</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Sayfanın Bilgilerini Bu Alandan Görüntüleyebilir ve Güncelleyebilirsiniz.</span>
                                            </h3>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div class="card-body pt-3 pb-0">
                                          ...
                                          if ($permissionControl == 0) {  // kullanıcının, yönetim panelinde blog yazısı ekleme ve düzenleme izni kontrol ediliyor
                                            $functions->errorList("noPageProcess");
                                          }
                                          ?>
                                              ...
                                              <div class="row">
                                                    <div class="col-12 col-lg-12">
                                                        <div class="form-group">
                                                            <label class="col-12 col-form-label">Sayfa Adı</label>
                                                            <input class="form-control h-auto form-control-solid py-4 px-8"
                                                                   type="text" placeholder="Sayfa Adı"
                                                                   name="pageName"
                                                                   autocomplete="off"
                                                                   value="<?php echo $pageDetail['pageName']; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-lg-6">
                                                        <div class="form-group mb-5">
                                                            <label class="col-12 col-form-label">Sayfa Kategorisi</label>
                                                            <select class="form-control form-control-lg form-control-solid"
                                                                    id="pageCategory" name="pageCategory">
                                                                <option disabled selected>Kategori Seçiniz</option>
                                                              <?php
                                                                $allCategoriesGet = $dbclass->cek("ASSOC_ALL", "categories", "uniqueId,categoryName", "WHERE categoryType=? AND langCode=? AND recordStatus=?", array(2, $pageDetail['langCode'], 1));
                                                                foreach ($allCategoriesGet as $key => $value) {
                                                                  $categoryDetected = $dbclass->cek("KAYITSAY", "pagesVsCategories", "COUNT(id)", "WHERE pageId=? AND categoryId=?", array($pageDetail['uniqueId'], $value['uniqueId']));
                                                      ...
                                                      <div class="form-group">
                                                        <label class="col-xl-12 col-form-label">Durumu</label>
                                                          ...
                                                          <?php 
                                                            $statupassive="";
                                                            $statuactive="";
                                                            if($pageDetail['recordStatus']==0)$statupassive="selected";
                                                    ...
                                                    <div class="col-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="pageContent"
                                                                    id="pageContent"><?php echo $pageDetail['pageContent']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--begin::Group-->
                                                <div class="form-group row">
                                                    <div class="col-12 col-lg-12">
                                                        ...
                                                        <input class="form-control form-control-solid form-control-lg"
                                                               name="seoTitle"
                                                               type="text" value="<?php echo $pageDetail['seoTitle']; ?>"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <textarea
                                                                ...
                                                                name="seoKeywords"
                                                                rows="5"
                                                                placeholder="SEO Anahtar Kelimeleri Giriniz"><?php echo $pageDetail['seoKeywords']; ?></textarea>
                                                    </div>
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <textarea
                                                                ...
                                                                name="seoDescription"
                                                                rows="5"
                                                                placeholder="SEO Açıklamasını Giriniz"><?php echo $pageDetail['seoDescription']; ?></textarea>
                                                        <input type="hidden" name="pageProcess" value="update">
                                                        <input type="hidden" name="id"
                                                               value="<?php echo $pageDetail['id']; ?>">
                                                    </div>
                                                </div>
                                                <div class="row border-lg justify-content-center rounded bg-white m-0 text-center my-4 p-2 ">
                                                    <?php
                                                    $productMainImage = $functions->imageDetected($dbclass, 7, $pageDetail['uniqueId'], $pageDetail['langCode'], 0);
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label class="col-form-label">Sayfa Tanıtım Görselleri</label>
    ...
    <script src="assets/js/pages/custom/pages/page-detail.js"></script>
